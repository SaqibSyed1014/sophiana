...
function Highlights() {
    return (
        <section className="major-highlights bg-skin py-36">
            <div className="container">
                <div className="w-3/4 mx-auto">
                    ...
                    <Parallax opacity={[0, 1]} easing="ease">
                        <p className="text-lg pr-60 pb-9 pt-14">
                            From everyday fine jewelry and high jewelry to vintage & estate jewels or important gemstones. We
                            curate the finest collections from independent jewelry houses and designers, connecting them with
                            our reseller network and their discerning clientele.
                        </p>
                    </Parallax>

                    <div className="gallery-highlights grid grid-cols-2 gap-7">
                        <Parallax opacity={[0, 1]} easing="ease">
